...
esttab m1 m2 m3 m4 m5 ///
    ...
    postfoot( ///
        ...
        "\footnotesize" ///
        "\item \textit{Notes:} The Wald test \$p\$-value corresponds to the null hypothesis that the coefficients on GPT and DS are equal. Standard errors clustered at the individual level. ***$p<0.01$, **$p<0.05$, *$p<0.1$." ///
        "\end{tablenotes}" ///
        "\end{threeparttable}" ///
        "\end{table}" ///
    )
...
esttab m1 m2 m3 m4 m5 m6 ///
    ...
    postfoot( ///
        ...
        "\begin{tablenotes}" ///
        "\footnotesize" ///
        "\item Notes: Standard errors clustered at the individual level. ***$p<0.01$, **$p<0.05$, *$p<0.1$." ///
        "\end{tablenotes}" ///
        "\end{threeparttable}" ///
        "\end{table}" ///
    )
...
esttab m1 m2 m3 m4 m5 m6 ///
    ...
    postfoot( ///
        ...
        "\begin{tablenotes}" ///
        "\footnotesize" ///
        "\item \textit{Notes:} Standard errors clustered at the individual level. ***$p<0.01$, **$p<0.05$, *$p<0.1$." ///
        "\end{tablenotes}" ///
        "\end{threeparttable}" ///
        "\end{table}" ///
    )
...
*--- Panel A: columns (1)-(4) ---*
esttab m1 m2 m3 m4 ///
    using "Table2.tex", replace fragment ///
...
esttab m5 m6 m7 m8 m9 ///
    using "Table2.tex", append fragment ///
    booktabs nomtitles nonumbers ///
    keep(H_d AI_s AI_d c.temp_exp#c.H_d c.temp_exp#c.AI_s c.temp_exp#c.AI_d) ///
    order(H_d AI_s AI_d c.temp_exp#c.H_d c.temp_exp#c.AI_s c.temp_exp#c.AI_d) ///
    coeflabels( ///
